...
document.getElementById('complete').addEventListener('change',remainingDays);
...
const isLeapYear = year => {
  ...
  function remainingDays(){
    console.log(document.getElementById('complete').innerText);
  ...
  //http://localhost:3002/details/:user/userboard
  //#endregion